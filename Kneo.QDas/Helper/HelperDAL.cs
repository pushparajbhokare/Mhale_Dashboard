...
namespace Kneo.QDas.DB
{
    public class HelperDAL
    {
        ...
        public HelperDAL()
        {
            //ConnectionString = ConfigurationManager.ConnectionStrings["TNTConnectionString"].ToString();
            //CreateConnection();
        }
        #endregion
        ...
        public List<T> ConvertTo<T>(DataTable datatable) where T : new()
        {
            ...
            try
            {
                ...
                //List<T> list = datatable.AsEnumerable().ToList().ConvertAll<T>(row => getObject<T>(row, columnsNames));
                return Temp;
            }
            catch
            {
